...
class MemberControllerTest {
    ...
    void detail_as_academy_admin_is_allowed() throws Exception {
        given(memberQueryService.get(any(), eq(3L))).willReturn(new MemberDetailResponse(
    ...
    void update_as_academy_admin_is_allowed() throws Exception {
        given(memberCommandService.update(any(), eq(3L), any())).willReturn(member());
    ...
    void resetPassword_as_academy_admin_returnsNoPasswordInBody() throws Exception {
        ...
        verify(memberCommandService).resetPassword(any(), eq(3L), any());
    }
    ...
    void remove_as_academy_admin_is_allowed() throws Exception {
        ...
        verify(memberCommandService).removeMembership(any(), eq(3L));
    }
