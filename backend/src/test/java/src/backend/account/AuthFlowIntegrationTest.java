...
class AuthFlowIntegrationTest {
     ...
     * Phase 3 목표 6). Phase 5 가 학생 관리 5개 · 차량·매니저 7개 · 자녀 연결 4개를 같은 이유로
    ...
    void 거부측_목록이_허용_목록_밖_실제_핸들러_전부와_일치한다() {
        ...
        assertThat(all)
                .as("프로덕션 핸들러 40개 — 늘었는데 이 단언만 고치면 거부측 목록이 낡는다. "
                        + "Phase 2 의 12 + Phase 3 의 12 + Phase 5 의 16(학생 5 + 차량·매니저 7 + 자녀 연결 4)")
                .hasSize(40);
