...
/**
 * 학생 하차 완료 — {@code RideEventCommandService.record()}가 ALIGHT 기록 커밋 후 발행한다.
 * 알림 모듈이 ALIGHT_DONE 알림을 만드는 데 필요한 최소 정보만 담는다.
 */
public record RideCompletedEvent(
    ...
    public static RideCompletedEvent of(RideEvent event, String studentName) {
