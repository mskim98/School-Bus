...
public class BusLocationCommandService {
    ...
    public BusLocationCommandService(BusLocationRepository busLocationRepository, BusRepository busRepository) {
    ...
    public void ingest(Long tenantId, Long busId, double lat, double lng, LocationOrigin origin) {
        busLocationRepository.save(new BusLocationPing(busId, tenantId, lat, lng, LocalDateTime.now(), origin));
    }
}
