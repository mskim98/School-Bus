 ...
 * 실제 유예시간 판정·알림은 {@link LocationCommandService#checkOverdueDisconnections}에 둔다.
 */
@Component
public class ConnectionLossScheduler {
    ...
    public ConnectionLossScheduler(LocationCommandService locationCommandService) {
    ...
    public void tick() {
        try {
            locationCommandService.checkOverdueDisconnections();
        } catch (Exception e) {
