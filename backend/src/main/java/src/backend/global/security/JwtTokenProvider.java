...
public class JwtTokenProvider {
    ...
    public String createAccessToken(Long accountId, Long academyId, Role role) {
        return build(accountId, academyId, role, TYPE_ACCESS, accessValidityMs);
    }

    public String createRefreshToken(Long accountId, Long academyId, Role role) {
        return build(accountId, academyId, role, TYPE_REFRESH, refreshValidityMs);
    }

    private String build(Long accountId, Long academyId, Role role, String type, long validityMs) {
        Date now = new Date();
        return Jwts.builder()
