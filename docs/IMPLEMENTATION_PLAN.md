...
| **6** | 노선 계산 파이프라인 · 고정 노선 | 5 | P0(유도) | 🟡 | 2026-08-29 착수. **오픈 이슈 G 는 막지 않음**(Ruling 178). 판정 **Ruling 178~185**. 목표 **11항 + 5-a**(`p6-goal-table.md`). **10항 회수**(T2 `c93be59` · T3 `f943177` · T1 `80e32e1` · T5 `b437c13` · T4 `c63f996`, 게이트 리뷰 **10회**). **미완 — 목표 9(T6 미착수) · 목표 11(전체 실증 미실시)**. 인수인계 `backend/report/2026-08-29-세션-인수인계.md` |
