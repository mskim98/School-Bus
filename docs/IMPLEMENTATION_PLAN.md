...
✅ **착수 전 판정 (2026-09-02) — 목표 표 12항을 `.superpowers/sdd/IMPLEMENTATION_PLAN/p12-goal-table.md` 에 고정했다.**
...
| **12** | 알림 설정 · 목록 · 수신 확인 · 로그 | 11 | P1 | ⬜ | **목표 표 12항 고정(2026-09-02, `p12-goal-table.md`) — 바로 발주 가능.** 착수 전 판정 **Ruling 216~218**. ⚠ **~~오픈 이슈 A·I·N~~ 이 낡았다** — **A** 는 이미 해소(2026-08-31) · **N** 은 `§3.14` 가 `boarding` 에 "운행 시작" 을 명시해 사실상 해소 · **I** 는 `NTF-06`(범위 밖)을 막는다. 대신 **`J` 잔여 ②**(기발송 알림 정정 방식)가 이 Phase 와 맞닿는데 표에 누락돼 있었다 |
| **13** | 모니터링 · 관제 | 12 | P1 | ⬜ | |
