...
| **6** | 노선 계산 파이프라인 · 고정 노선 | 5 | P0(유도) | 🟡 | 2026-08-29 착수. **오픈 이슈 G 는 막지 않음**(Ruling 178 — 판정 수단이 `TECH_DECISIONS §8.5` 에 이미 규정). 착수 전 판정 5건 = Ruling 178~182. 목표 **11항**(`p6-goal-table.md`) |
